                ...
                If pVal.BeforeAction Then
                    Select Case pVal.EventType
                        Case SAPbouiCOM.BoEventTypes.et_CLICK
                            If bModal And (objaddon.objapplication.Forms.ActiveForm.TypeEx = "133" Or objaddon.objapplication.Forms.ActiveForm.TypeEx = "139") Then
                                BubbleEvent = False
                                Try
                                    objapplication.Forms.Item("PRETRAN").Select()
                                Catch ex As Exception
                                End Try
                            End If
                        ...
                        Case SAPbouiCOM.BoEventTypes.et_FORM_CLOSE
                            ...
                            If FormUID = "PRETRAN" And (EventEnum = SAPbouiCOM.BoEventTypes.et_FORM_CLOSE) And bModal Then
                                bModal = False
                            End If
        ...
        Public Sub SBO_Application_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles objapplication.MenuEvent
            Try
                Select Case pVal.MenuUID
                    Case "1281", "1282", "1283", "1284", "1285", "1286", "1287", "1300", "1288", "1289", "1290", "1291", "1304", "1292", "1293", "VPRICE", "6005", "6913"
